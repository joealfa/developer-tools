...
import type { SessionTracker } from './session/sessionTracker';
...
class ExtensionState {
	...
	private static _sessionTracker: SessionTracker | null = null;
	...
	static setSessionTracker(tracker: SessionTracker): void {
		this._sessionTracker = tracker;
	}

	static getSessionTracker(): SessionTracker | null {
		return this._sessionTracker;
	}

	static takeSessionTracker(): SessionTracker | null {
		const tracker = this._sessionTracker;
